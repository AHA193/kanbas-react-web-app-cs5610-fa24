...
export default function Lab2() {
    ...
    <p>
        ...
        Dolores aspernatur reprehenderit error alias! Facilis enim 
        odio ad quaerat similique. Blanditiis, dolore. Voluptatem 
    </p>
...
to a specific element by the ID
</p>
...
styles depending on the dociument structure
</p>
</div>
</div>
</div>
...
Foreground color</h3>
<p className="bg-color-red fb-color-black">
This background of the paragraph is red but
<span className="bg-color-green fg-color-white">
the background of this text is green and 
foreground white
</span>
</p>
...
width
        ...
        <span style={{
            ...
            <p className="rounded-corners-top border-thin border-blue border-solid padding-fat">
